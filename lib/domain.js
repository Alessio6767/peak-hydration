...
const PACKAGES = {
  essential: {
    ...
    pricePerDelivery: 119,
    image: 'assets/package-essential.jpg',
  },
  active: {
    id: 'active',
    name: 'Active',
    tagline: '10L for the house plus a full case of 500ml for the road.',
    items: [{ productId: '5l', qty: 2 }, { productId: 'case24', qty: 1 }],
    pricePerDelivery: 349,
    image: 'assets/package-active.jpg',
  },
  peak: {
    id: 'peak',
    name: 'Peak',
    tagline: 'The full setup — 20L in 5L bottles and a case of 500ml.',
    items: [{ productId: '5l', qty: 4 }, { productId: 'case24', qty: 1 }],
    pricePerDelivery: 409,
    image: 'assets/package-peak.jpg',
    badge: 'Best value',
  },
};
...
// deliveryFee is charged per delivery on top of the package price;
// deliveriesPerMonth is only used for the revenue estimate.
const FREQUENCIES = {
  weekly:   { id: 'weekly',   name: 'Weekly',        intervalDays: 7,  deliveryFee: 199, deliveriesPerMonth: 4 },
  biweekly: { id: 'biweekly', name: 'Every 2 weeks', intervalDays: 14, deliveryFee: 119, deliveriesPerMonth: 2 },
  monthly:  { id: 'monthly',  name: 'Monthly',       intervalDays: 28, deliveryFee: 89,  deliveriesPerMonth: 1 },
};

// Deliveries run on fixed weekdays only, within DELIVERY_WINDOW.
const DELIVERY_DAYS = {
  monday:    { id: 'monday',    name: 'Monday',    weekday: 1 },
  wednesday: { id: 'wednesday', name: 'Wednesday', weekday: 3 },
};
const DELIVERY_WINDOW = '8AM – 5PM';
...
// What each debit order collects: package price + the frequency's delivery fee.
function totalPerDelivery(packageId, frequencyId) {
  return PACKAGES[packageId].pricePerDelivery + FREQUENCIES[frequencyId].deliveryFee;
}
...
function validateSubscriptionInput(body) {
  ...
  need(!!DELIVERY_DAYS[body.deliveryDay], 'Delivery day must be Monday or Wednesday');
...
module.exports = {
  PRODUCTS, PACKAGES, AREAS, FREQUENCIES, DELIVERY_DAYS, DELIVERY_WINDOW,
  BILLING_LEAD_DAYS, FIRST_DELIVERY_MIN_LEAD_DAYS,
  todayString, addDays, nextDeliveryDate, followingDeliveryDate,
  debitDueDate, packageContents, totalPerDelivery, validateSubscriptionInput,
};
